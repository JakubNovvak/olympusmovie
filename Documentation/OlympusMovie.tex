...
\newgeometry{tmargin=2.5cm, bmargin=2.5cm, lmargin=3cm, rmargin=1.5cm}
	...
	\section{Określenie wymagań}
		\subsection{Diagramy przypadków użycia}
			\includegraphics[scale=0.9]{UseCase_UserLoggedIn.png}
			
			\includegraphics[scale=0.9]{UseCase_UserNotLoggedIn.png}
		%\subsection{Badanie konkurencji i rynku}
		%\subsection{Wymagania biznesowe}
		%\subsection{Cele platformy}
	...
	\section{Architektura i zakres projektu}
		%\subsection{Architektura strony}
		\subsection{Architektura baz danych}
			\begin{center}
				\includegraphics[scale=0.7]{Class_FilmsDataBase.png}
			\end{center}
