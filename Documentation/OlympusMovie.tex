...
\pagebreak
	\section{Specyfikacja wymagań biznesowych}
		...
		Celem projektu "Olympus Movie" jest stworzenie strony internetowej poświęconej filmom, serialom oraz osobom uczestniczącym w ich tworzeniu. Użytkownik po zarejestrowaniu i zalogowaniu jest w stanie %komentować, 
...
%			\item Wyszukanie pozycji na podstawie filtrów.\linebreak
		...
		\begin{itemize}
			...
			\includegraphics[scale=0.7]{Ocena.png}
			\item Dodanie recenzji do pozycji.
			%\item Skomentowanie recenzji.
			\item Dodanie pozycji do jednej z list. \linebreak
			Po otwarciu danego filmu pod oceną znajduje się rozwijana lista ze statusami pozycji.\linebreak
