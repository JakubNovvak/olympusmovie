    ...
    >
      <Container>
        {props.seclectedEntry ? (
          <>
            <CoverImage
              src={props.seclectedEntry.photo}
              alt={props.seclectedEntry.title}
            />
            <InfoColumn>
              <MovieName>
                {props.seclectedEntry.Type}:{" "}
                <span>{props.seclectedEntry.title}</span>
              </MovieName>
              <MovieInfo>
            ...
            <Button
              ...
              color="error"
              style={{ height: "25px" }}
              onClick={() => props.setSelectedEntry()}
            >
              Zamknij
            </Button>
          </>
